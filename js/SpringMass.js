...
canvas.addEventListener('touchmove', (e) => {
    ...
    // mouse.x=e.touches[0].screenX - e.touches[0].clientX;
    // mouse.y=e.touches[0].screenY-e.touches[0].clientY;
});
...
// SPRING sound url
const sound_url_spring='http://codeskulptor-demos.commondatastorage.googleapis.com/pang/arrow.mp3';
...
canvas.addEventListener('resize',function(){updateMeanPositions();})

// Event listener for fullscreen change resizing
document.addEventListener('fullscreenchange',function(){updateMeanPositions();})
